...
<body class="align">
  ...
  <div class="grid">
    ...
    <form  method="POST" class="form login" action="chefdata.jsp">
	<h1 style="color:black;">ANNAPURNA</h1>
      <div class="form__field">
        <label for="login__username"><svg class="icon">
            <use xlink:href="#icon-user"></use>
          </svg><span class="hidden">Chefname</span></label>
        <input  type="text" name="cn" class="form__input" placeholder="Chefname" required>
      </div>
 <div class="form__field">
        <label for="login__username"><svg class="icon">
            <use xlink:href="#icon-user"></use>
          </svg><span class="hidden">Mobile No</span></label>
        <input   type="text" name="cmo" class="form__input" placeholder="Mobile No" required>
      </div>
       <div class="form__field">
        <label for="login__username"><svg class="icon">
            <use xlink:href="#icon-user"></use>
          </svg><span class="hidden">Address</span></label>
        <input  type="text" name="cadd" class="form__input" placeholder="Address" required>
      </div>
       <div class="form__field">
        <label for="login__username"><svg class="icon">
            <use xlink:href="#icon-user"></use>
          </svg><span class="hidden">Experience</span></label>
        <input  type="text" name="cexp" class="form__input" placeholder="Experience" required>
      </div> 
 <div class="form__field">
